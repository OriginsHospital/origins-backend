...
async function main() {
  const TARGET_FIRST_NAME = "Tejaswini";
  const TARGET_LAST_NAME = "Vedipala";
  const NEW_DAY1_DATE = "2026-04-14"; // Day 1 => 14/04, sequence follows daily
  ...
  try {
    ...
    console.log(`FET Day 1 set to: ${NEW_DAY1_DATE} (shows as 14/04)`);
  } catch (e) {
    await tx.rollback();
    throw e;
  } finally {
