-- =============================================
-- Patient Tracker Table Creation Script
-- =============================================
...
CREATE TABLE IF NOT EXISTS patient_tracker (
    ...
    -- Note: embryosRemaining can be calculated as (numberOfEmbryos - numberOfEmbryosUsed)
    embryosRemaining INT GENERATED ALWAYS AS (numberOfEmbryos - numberOfEmbryosUsed) STORED COMMENT 'Embryos remaining (auto-calculated)',
...
-- =============================================
-- Alternative: If you want to use patient_master.id instead of patientId string
-- =============================================
-- You can modify the table to reference patient_master.id directly:
-- 
-- ALTER TABLE patient_tracker
-- ADD COLUMN patientMasterId INT AFTER patientId,
-- ADD FOREIGN KEY (patientMasterId) REFERENCES patient_master(id) ON DELETE RESTRICT ON UPDATE CASCADE,
-- ADD INDEX idx_patientMasterId (patientMasterId);
-- =============================================
