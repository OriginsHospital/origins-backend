-- =====================================================
-- FIX TICKETS TABLE STRUCTURE
-- =====================================================
-- This migration fixes the tickets table structure
-- to match the expected schema for the ticketing system
-- =====================================================

-- Drop the existing incorrect tickets table if it exists
-- WARNING: This will delete all existing data in the tickets table
DROP TABLE IF EXISTS ticket_tags;
DROP TABLE IF EXISTS ticket_comments;
DROP TABLE IF EXISTS ticket_activity_logs;
DROP TABLE IF EXISTS tickets;

-- Create the correct tickets table structure
CREATE TABLE IF NOT EXISTS tickets (
    ...
    category VARCHAR(100) NULL COMMENT 'Ticket category (e.g., Maintenance, Equipment, Supplies, Follow-up)',
...
-- Create ticket_activity_logs table for audit trail
